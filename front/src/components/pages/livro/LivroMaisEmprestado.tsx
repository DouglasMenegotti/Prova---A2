...
function LivrosMaisEmprestado() {
    ...
    async function carregarLivrosAPI() {
        try {
            const resposta = await api.get<Livro[]>("/api/livro/maisemprestado");
...
export default LivrosMaisEmprestado;
